 ...
 **/
 ...
 var options = {
  scaleColor: false,
  trackColor: 'rgba(204,204,204,0.3)',
  barColor: '#53c9b3',
  lineWidth: 6,
  lineCap: 'butt',
  size: 120
...
$( ".chart" ).click(function() {
    ...
    var query_params = $( this ).attr('id');
    var url = window.location;
    var requestUrl = url.protocol + "//" + url.host + "/organizations/pledges/new?" + query_params
